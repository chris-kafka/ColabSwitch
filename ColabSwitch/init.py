...
class _af_init:
  ...
  def _prep_switch(self, pdb_filename, chain=None, binder_len=50, hotspot=None, **kwargs):
    '''prep inputs for binder design'''
    ...
    self._inputs_sw = self._prep_features(binder_len)
    self._inputs_sw["residue_index"][..., :] = np.arange(binder_len) + 50
